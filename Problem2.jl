...
# ╔═╡ 7c60c7f0-1162-11f0-0581-9739b9db6163
using PlutoUI, CSV, DataFrames, Statistics, Plots, MLJ

# ╔═╡ 3d5a4a8d-3d29-47b7-a0b4-809b82759e80
# UI Controls
TableView = PlutoUI.TableOfContents()

# ╔═╡ 045980fd-46f0-4fdb-8143-d732e31a989f
fetal_health_data = CSV.read("C:\\Users\\s.ndongo\\OneDrive - I-TECH Namibia\\NUST\\TAI911S\\Assignment 1\\fetal_health.csv", DataFrame)

# ╔═╡ 76e05c6b-d961-4c4c-b412-7ee5f162a90c
begin
	# Exploratory Data Analysis (EDA)
		describe(fetal_health_data)
end

# ╔═╡ 589fe261-ce65-4710-97b6-04851352bc27
begin
	#Checking for missing values
	println("Missing values by column in the Global Food Data:")
		println(map(col -> (col => count(ismissing, fetal_health_data[:, col])), names(fetal_health_data)))
end

# ╔═╡ 6c3c418c-bfc0-49e4-9220-fd390425ce4a
begin
	# Handle missing values (if any)
	fhdata_cleaned = dropmissing(fetal_health_data)  # Removes rows with any missing values
end

# ╔═╡ 269dff50-c80f-41b6-8452-d7a26aae60b7
begin
	# Correlation analysis
	correlation_matrix = cor(Matrix(fhdata_cleaned))
	println("Correlation Matrix:")
	println(correlation_matrix)
end

# ╔═╡ 231f18b2-90ac-496c-ac13-a872888fc2ee
begin
	# Splitting the Data
	X = select(fhdata_cleaned, Not(:fetal_health))
	y = fhdata_cleaned[:, :fetal_health]
end

# ╔═╡ fb879b64-ce59-40c1-87b3-bf04f2a529e8
begin
...
# ╔═╡ 4a05b18f-bf1f-4b83-a089-d2363b968a80
begin
	# Evaluation Metrics for Classification
	predictions3 = predict(mach3, X)
	accuracy = sum(predictions3 .== y) / length(y)
	println("Accuracy for Fetal Health Classification: $accuracy")
end

# ╔═╡ 0eb4a4c6-b4bb-4b8c-8cec-09e86d0af326
# Display Outputs
TableView
...
manifest_format = "2.0"
project_hash = "1cfb78987716ed1573d42cba169d766233bf409e"

...
# Load dataset
begin
    df = DataFrame(CSV.File("C:\\Users\\s.ndongo\\OneDrive - I-TECH Namibia\\NUST\\TAI911S\\Assignment 1\\global_food_wastage_dataset.csv"))
...
# ╔═╡ bfee2391-5369-4dc2-afee-b768647163e7
begin
	regression_model1 = @load LinearRegressor pkg=MLJLinearModels
	mach1 = machine(regression_model1, X_fruit_wastage, y_fruit_wastage)
	fit!(mach1)
...
X_dairy_waste = select(dairy_waste_data, Not(:"Household Waste (%)","Food Category"))


# Target: Household Waste (assuming the column is Household Waste(%)")

# ╔═╡ a09f38b1-96b9-4ff5-9fa2-6e4298488894
y_dairy_waste = dairy_waste_data[!, :"Household Waste (%)"]
